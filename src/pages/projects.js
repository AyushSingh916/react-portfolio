...
const DisplayProjects = () => {
    const personalProjects = projects.personalProjects;
        ...
        if (project.colSize === 12) {
            ...
            return (
                <Project
                    ...
                    title={title}
                    img={img}
                    summary={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dolor fugiat reprehenderit error est? Saepe natus totam consequatur dolore, eligendi molestias maiores nobis ad culpa labore, consequuntur officia optio fugiat."}
                    link={"#"}
                    github={"github"}
                    technologies={technologies}
                />
